...
ptip_cmd3 = PtpIpCmdRequest(cmd=0x9110, data_phase=0x02, tid=ptpip.transaction_id)
...
ptip_cmd6 = PtpIpCmdRequest(cmd=0x9110, data_phase=0x02, tid=ptpip.transaction_id)
ptip_cmd7 = PtpIpCmdRequest(cmd=0x9102, param1=0x00010001, tid=ptpip.transaction_id)
ptip_cmd8 = PtpIpCmdRequest(cmd=0x9102, param1=0x00020000, tid=ptpip.transaction_id)
