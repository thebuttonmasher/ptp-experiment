...
ptip_cmd5 = PtpIpCmdRequest(cmd=0x9129, param1=0x1, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd6 = PtpIpCmdRequest(cmd=0x9128, param1=0x1, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd7 = PtpIpCmdRequest(cmd=0x9129, param1=0x1, param2=0x0, tid=ptpip.transaction_id)# param1=0x00010001, tid=ptpip.transaction_id)
