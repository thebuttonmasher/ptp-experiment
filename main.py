...
ptip_cmd5 = PtpIpCmdRequest(cmd=0x9129, param1=0x2, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd6 = PtpIpCmdRequest(cmd=0x9128, param1=0x2, param2=0x0, tid=ptpip.transaction_id)
