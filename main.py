...
ptip_cmd3 = PtpIpCmdRequest(cmd=0x910f, data_phase=0x01, tid=ptpip.transaction_id)
...
ptip_cmd6 = PtpIpCmdRequest(cmd=0x9008, data_phase=0x02, tid=ptpip.transaction_id)
ptip_cmd7 = PtpIpCmdRequest(cmd=0x9009, tid=ptpip.transaction_id)# param1=0x00010001, tid=ptpip.transaction_id)
ptip_cmd8 = PtpIpCmdRequest(cmd=0x100e, tid=ptpip.transaction_id)# param1=0x00020000, tid=ptpip.transaction_id)
