...
ptip_cmd4 = PtpIpCmdRequest(cmd=0x9128, param1=0x1, param2=0x0, tid=ptpip.transaction_id)
...
ptip_cmd7 = PtpIpCmdRequest(cmd=0x9129, param1=0x1, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd8 = PtpIpCmdRequest(cmd=0x9128, param1=0x4, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd9 = PtpIpCmdRequest(cmd=0x9129, param1=0x4, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd10 = PtpIpCmdRequest(cmd=0x9128, param1=0x4, param2=0x0, tid=ptpip.transaction_id)
ptip_cmd11 = PtpIpCmdRequest(cmd=0x9129, param1=0x4, param2=0x0, tid=ptpip.transaction_id)
#ptip_cmd8 = PtpIpCmdRequest(cmd=0x910f, tid=ptpip.transaction_id)#, param1=0x1, param2=0x0,tid=ptpip.transaction_id)
cmds = [ptip_cmd1, ptip_cmd2, ptip_cmd4, ptip_cmd5, ptip_cmd6, ptip_cmd7, ptip_cmd8, ptip_cmd9, ptip_cmd10, ptip_cmd11]
for cmd in cmds:
