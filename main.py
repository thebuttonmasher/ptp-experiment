...
ptip_cmd3 = PtpIpCmdRequest(cmd=0x9110, data_phase=0x01, param1=0xc, param2=0xd1b8, param3=0x4 ,tid=ptpip.transaction_id)
...
ptip_cmd6 = PtpIpCmdRequest(cmd=0x9110, data_phase=0x01, param1=0xc, param2=0xd1b8, param3=0x0, tid=ptpip.transaction_id)
